...
");}
if(err){$("#comments-reply").prepend("<p><b>Your comment was not submitted</b></p>");}
$("#ecommentsreply").bind("submit",(function(){$("#ecommentsreply").hide();$.ajax({type:"POST",url:url,data:$("#ecommentsreply").serialize(),error:function(r,e){loadComments(url,options,(r.status==500));},complete:function(r,e){loadComments(url,options,(r.status==500));},datatype:'jsonp',});return false;}));}
