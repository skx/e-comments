...
function populateReplyForm(url,options){if(options&&options["reply-placement"])
...
");}
$("#ecommentsreply").bind("submit",(function(){$("#ecommentsreply").hide();$.ajax({type:"POST",url:url,data:$("#ecommentsreply").serialize(),error:function(r,e){loadComments(url);},complete:function(r,e){loadComments(url);},datatype:'jsonp',})
return false;}));}
